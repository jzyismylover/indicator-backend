# -*-  coding:utf-8 -*-
from resources.zh_readability.feature_bean.entity_feature import EntityFeature
from resources.zh_readability.feature_bean.named_entity_feature import NamedEntityFeature
from resources.zh_readability.feature_bean.nonentity_noun import NonentityNoun
from resources.zh_readability.feature_bean.nonnamed_entity_noun_feature import NonnamedEntityNounFeature
...
def feature81_92(data_set):
    ...
    data_set.features_dict["83|ED-83|"] = round(entity_feature.get_percentage_entity_per_doc(data_set.words), 4)
    data_set.features_dict["84|ED-84|"] = round(entity_feature.get_percentage_unique_entity_per_doc(data_set.words), 4)
    ...
    data_set.features_dict["87|ED-87|"] = round(named_entity_feature.get_percentage_named_entity_per_doc(data_set.words), 4)
    ...
    data_set.features_dict["90|ED-90|"] = round(nonnamed_entity_noun_feature.get_percentage_not_name_entity_noun_per_doc(data_set.words), 4)
