...
# 基于 urduhack/urduhack/tokenization
class UrduUtils(BaseUtils):
...
if __name__ == '__main__':
    raw_text = 'عراق اور شام نے اعلان کیا ہے دونوں ممالک جلد اپنے اپنے سفیروں کو واپس بغداد اور دمشق بھیج دیں گے؟'
    urdu_utils = UrduUtils()
    sentences = urdu_utils.get_sentences(raw_text)
    print(sentences)